...
export const siteConfig: SiteConfig = {
	title: "猪头少尉",
	subtitle: "猪头少尉的博客",
	siteURL: "https://lilaccccc.github.io/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-03-06", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	favicon: [
		{
		  src: 'https://avatars.githubusercontent.com/u/105717407?v=4',    // 图标文件路径
...
export const profileConfig: ProfileConfig = {
	avatar: "https://avatars.githubusercontent.com/u/105717407?v=4", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "猪头少尉",
	bio: "",
	typewriter: {
